...
"[project]/contexts/database-store-context.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";

// Database-powered store context for StockMaster
__turbopack_context__.s([
...
function DatabaseStoreProvider({ children }) {
    ...
    // Initialize database
    const initializeDatabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        try {
            setLoading(true);
            setError(null);
            await apiCall('/api/database/init', {
                method: 'POST'
            });
            await refreshData();
        } catch (err) {
    ...
    // Delivery operations
    const addDelivery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (delivery)=>{
        try {
            setError(null);
            ...
            const errorMessage = err instanceof Error ? err.message : 'Failed to add delivery';
            setError(errorMessage);
            throw err;
        }
    }, [
    ...
    // Stock operations
    const updateLocationStock = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (productId, locationId, quantity, operation)=>{
        try {
            setError(null);
            await apiCall('/api/stock/update', {
                method: 'POST',
                body: JSON.stringify({
                    productId,
                    locationId,
    ...
    // Temporary implementations for missing operations
    const addReceipt = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (receipt)=>{
        console.log('Receipt creation not yet implemented:', receipt);
        return Date.now().toString();
    }, []);
    const updateReceipt = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (id, updates)=>{
        console.log('Receipt update not yet implemented:', id, updates);
    }, []);
    const updateDelivery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (id, updates)=>{
        console.log('Delivery update not yet implemented:', id, updates);
    }, []);
    const addTransfer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (transfer)=>{
        console.log('Transfer creation not yet implemented:', transfer);
        return Date.now().toString();
    }, []);
    const updateTransfer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (id, updates)=>{
        console.log('Transfer update not yet implemented:', id, updates);
    }, []);
    const addAdjustment = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (adjustment)=>{
        console.log('Adjustment creation not yet implemented:', adjustment);
        return Date.now().toString();
    }, []);
    const addLedgerEntry = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (entry)=>{
        console.log('Ledger entry creation not yet implemented:', entry);
    }, []);
    // Helper functions
    const getLocationStock = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((productId, locationId)=>{
        const product = products.find((p)=>p.id === productId);
        if (!product || !product.locationStocks) return 0;
        const locationStock = product.locationStocks.find((ls)=>ls.locationId === locationId);
        return locationStock?.quantity || 0;
    }, [
        products
    ]);
    const getLowStockProducts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
        return products.filter((p)=>p.reorderLevel && p.stock <= p.reorderLevel);
    }, [
        products
    ]);
    const getLocationStockSummary = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((locationId)=>{
        return products.map((product)=>({
                productId: product.id,
                productName: product.name,
                sku: product.sku,
                stock: getLocationStock(product.id, locationId),
                uom: product.uom
    ...
    const getStats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
        return {
            ...
            pendingReceipts: receipts.filter((r)=>r.status === "WAITING" || r.status === "DRAFT").length,
            pendingDeliveries: deliveries.filter((d)=>d.status === "WAITING" || d.status === "DRAFT").length,
            scheduledTransfers: transfers.filter((t)=>t.status === "WAITING" || t.status === "DRAFT").length
        };
    }, [
        products,
        receipts,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const initialize = async ()=>{
            try {
                // Try to get stats first to check if database is initialized
                await apiCall('/api/database/init');
                await refreshData();
            } catch (err) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(StoreContext.Provider, {
        ...
        fileName: "[project]/contexts/database-store-context.tsx",
        lineNumber: 351,
        columnNumber: 5
    }, this);
}
function useStore() {
    ...
    if (context === undefined) {
        throw new Error("useStore must be used within a DatabaseStoreProvider");
    }
    return context;
}
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b30a595a._.js.map