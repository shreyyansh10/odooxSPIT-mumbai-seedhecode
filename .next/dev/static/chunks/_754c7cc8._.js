...
"[project]/contexts/database-store-context.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function DatabaseStoreProvider({ children }) {
    ...
    // Initialize database
    const initializeDatabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DatabaseStoreProvider.useCallback[initializeDatabase]": async ()=>{
            try {
                setLoading(true);
                setError(null);
    ...
    }["DatabaseStoreProvider.useCallback[initializeDatabase]"], []);
    ...
    const refreshData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DatabaseStoreProvider.useCallback[refreshData]": async ()=>{
            try {
                setLoading(true);
                setError(null);
    ...
    }["DatabaseStoreProvider.useCallback[refreshData]"], []);
    // Product operations
    const addProduct = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DatabaseStoreProvider.useCallback[addProduct]": async (product)=>{
            try {
                setError(null);
    ...
    }["DatabaseStoreProvider.useCallback[addProduct]"], [
        refreshData
    ]);
    const updateProduct = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DatabaseStoreProvider.useCallback[updateProduct]": async (id, updates)=>{
            try {
                setError(null);
    ...
    }["DatabaseStoreProvider.useCallback[updateProduct]"], [
        refreshData
    ]);
    const deleteProduct = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DatabaseStoreProvider.useCallback[deleteProduct]": async (id)=>{
            try {
                setError(null);
                await apiCall(`/api/products/${id}`, {
                    method: 'DELETE'
    ...
    }["DatabaseStoreProvider.useCallback[deleteProduct]"], [
        refreshData
    ]);
    // Delivery operations
    const addDelivery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DatabaseStoreProvider.useCallback[addDelivery]": async (delivery)=>{
            try {
                setError(null);
    ...
    }["DatabaseStoreProvider.useCallback[addDelivery]"], [
        refreshData
    ]);
    // Stock operations
    const updateLocationStock = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DatabaseStoreProvider.useCallback[updateLocationStock]": async (productId, locationId, quantity, operation)=>{
            try {
                setError(null);
    ...
    }["DatabaseStoreProvider.useCallback[updateLocationStock]"], [
        refreshData
    ]);
    ...
    const addReceipt = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DatabaseStoreProvider.useCallback[addReceipt]": async (receipt)=>{
            console.log('Receipt creation not yet implemented:', receipt);
            return Date.now().toString();
        }
    }["DatabaseStoreProvider.useCallback[addReceipt]"], []);
    const updateReceipt = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DatabaseStoreProvider.useCallback[updateReceipt]": async (id, updates)=>{
            console.log('Receipt update not yet implemented:', id, updates);
        }
    }["DatabaseStoreProvider.useCallback[updateReceipt]"], []);
    const updateDelivery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DatabaseStoreProvider.useCallback[updateDelivery]": async (id, updates)=>{
            console.log('Delivery update not yet implemented:', id, updates);
        }
    }["DatabaseStoreProvider.useCallback[updateDelivery]"], []);
    const addTransfer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DatabaseStoreProvider.useCallback[addTransfer]": async (transfer)=>{
            console.log('Transfer creation not yet implemented:', transfer);
            return Date.now().toString();
        }
    }["DatabaseStoreProvider.useCallback[addTransfer]"], []);
    const updateTransfer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DatabaseStoreProvider.useCallback[updateTransfer]": async (id, updates)=>{
            console.log('Transfer update not yet implemented:', id, updates);
        }
    }["DatabaseStoreProvider.useCallback[updateTransfer]"], []);
    const addAdjustment = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DatabaseStoreProvider.useCallback[addAdjustment]": async (adjustment)=>{
            console.log('Adjustment creation not yet implemented:', adjustment);
            return Date.now().toString();
        }
    }["DatabaseStoreProvider.useCallback[addAdjustment]"], []);
    const addLedgerEntry = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DatabaseStoreProvider.useCallback[addLedgerEntry]": async (entry)=>{
            console.log('Ledger entry creation not yet implemented:', entry);
        }
    }["DatabaseStoreProvider.useCallback[addLedgerEntry]"], []);
    // Helper functions
    const getLocationStock = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DatabaseStoreProvider.useCallback[getLocationStock]": (productId, locationId)=>{
            const product = products.find({
                "DatabaseStoreProvider.useCallback[getLocationStock].product": (p)=>p.id === productId
            }["DatabaseStoreProvider.useCallback[getLocationStock].product"]);
            if (!product || !product.locationStocks) return 0;
            const locationStock = product.locationStocks.find({
                "DatabaseStoreProvider.useCallback[getLocationStock].locationStock": (ls)=>ls.locationId === locationId
            }["DatabaseStoreProvider.useCallback[getLocationStock].locationStock"]);
            return locationStock?.quantity || 0;
        }
    }["DatabaseStoreProvider.useCallback[getLocationStock]"], [
        products
    ]);
    const getLowStockProducts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DatabaseStoreProvider.useCallback[getLowStockProducts]": ()=>{
            return products.filter({
                "DatabaseStoreProvider.useCallback[getLowStockProducts]": (p)=>p.reorderLevel && p.stock <= p.reorderLevel
            }["DatabaseStoreProvider.useCallback[getLowStockProducts]"]);
        }
    }["DatabaseStoreProvider.useCallback[getLowStockProducts]"], [
        products
    ]);
    const getLocationStockSummary = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DatabaseStoreProvider.useCallback[getLocationStockSummary]": (locationId)=>{
            return products.map({
                "DatabaseStoreProvider.useCallback[getLocationStockSummary]": (product)=>({
            ...
            }["DatabaseStoreProvider.useCallback[getLocationStockSummary]"]).filter({
                "DatabaseStoreProvider.useCallback[getLocationStockSummary]": (item)=>item.stock > 0
            }["DatabaseStoreProvider.useCallback[getLocationStockSummary]"]);
        }
    }["DatabaseStoreProvider.useCallback[getLocationStockSummary]"], [
        products,
        getLocationStock
    ...
    const getStats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DatabaseStoreProvider.useCallback[getStats]": ()=>{
            return {
                totalProducts: products.length,
                lowStockItems: products.filter({
                    "DatabaseStoreProvider.useCallback[getStats]": (p)=>p.stock < 20
                }["DatabaseStoreProvider.useCallback[getStats]"]).length,
                outOfStockItems: products.filter({
                    "DatabaseStoreProvider.useCallback[getStats]": (p)=>p.stock === 0
                }["DatabaseStoreProvider.useCallback[getStats]"]).length,
                pendingReceipts: receipts.filter({
                    "DatabaseStoreProvider.useCallback[getStats]": (r)=>r.status === "WAITING" || r.status === "DRAFT"
                }["DatabaseStoreProvider.useCallback[getStats]"]).length,
                pendingDeliveries: deliveries.filter({
                    "DatabaseStoreProvider.useCallback[getStats]": (d)=>d.status === "WAITING" || d.status === "DRAFT"
                }["DatabaseStoreProvider.useCallback[getStats]"]).length,
                scheduledTransfers: transfers.filter({
                    "DatabaseStoreProvider.useCallback[getStats]": (t)=>t.status === "WAITING" || t.status === "DRAFT"
                }["DatabaseStoreProvider.useCallback[getStats]"]).length
            };
        }
    }["DatabaseStoreProvider.useCallback[getStats]"], [
    ...
    // Initialize on mount
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DatabaseStoreProvider.useEffect": ()=>{
            const initialize = {
                "DatabaseStoreProvider.useEffect.initialize": async ()=>{
                    try {
            ...
            }["DatabaseStoreProvider.useEffect.initialize"];
            initialize();
        }
    }["DatabaseStoreProvider.useEffect"], [
        initializeDatabase,
...
_s(DatabaseStoreProvider, "iLKLf5uIAlJr1pOgpzCMn5tFKZA=");
_c = DatabaseStoreProvider;
function useStore() {
    _s1();
...
var _c;
__turbopack_context__.k.register(_c, "DatabaseStoreProvider");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_754c7cc8._.js.map